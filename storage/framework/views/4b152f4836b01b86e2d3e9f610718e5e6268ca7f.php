                        ...
                        <?php $__currentLoopData = $investigadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $investigador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            ...
                            <td><?php echo e($investigador->fecha_registro_investigador); ?></td>
                             ...
                             <td><a href="<?php echo e(route('investigadores.edit', $investigador->id)); ?>" class="btn btn-default btn-flat">Editar</a></td>

                            <td><a href="<?php echo e(route('admin.investigadores.destroy', $investigador->id)); ?>" onclick="return confirm('¿Esta seguro que desea eliminar el investigador?')" class="btn btn-default btn-flat">Eliminar</a></td>
                          </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				            </table>
